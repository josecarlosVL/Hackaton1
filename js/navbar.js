...
<nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="/Hackaton1/"><img src="/Hackaton1/images/zunzo.png"></a>
    ...
    <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0 align-items-center">
        <li class="nav-item  d-lg-none">
          <a class="nav-link" href="/Hackaton1/">Inicio</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/Hackaton1/pages/calzado.html">Calzado</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/Hackaton1/pages/error.html">Ropa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/Hackaton1/pages/ofertas.html">Ofertas</a>
        </li>
        <li class="nav-item  d-lg-none">
          <a class="nav-link" href="#">Login/Register</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/Hackaton1/pages/about.html">About us</a>
        </li>
        <li class="nav-item  d-lg-none">
        ...
        <li class="nav-item d-none d-lg-flex flex-column align-items-center mx-3">
            <a href="#" class="nav-link p-0 text-center text-dark">
                <img src="/Hackaton1/images/user.png" width="36px" height="36px" class="mb-1" alt="User">
                <div>Login/Register</div>
            </a>
        </li>
        <li class="nav-item d-none d-lg-flex flex-column align-items-center mx-3">
            <a href="#" class="nav-link p-0 text-center text-dark">
                <img src="/Hackaton1/images/carrito.png" width="36px" height="36px" class="mb-1" alt="Cart">
                <div>Carrito</div>
            </a>
        </li>
    </div>
